...
*   **Accuracy Check:** Resolved overlapping peaks on standard alcohol/alkane mixes. Area double-counting errors reduced by **46.1% to 48.8%** on CPU in under 12 seconds.
